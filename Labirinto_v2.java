...
public class Labirinto_v2{
  ...
  public static void main(String[] args){
    ...
    int ataque = 20;
    int classe = 1;
    int cont_inimigo = 0; //contador para saber em qual adversÃ¡rio estamos
    ...
    System.out.println("PARABÉNS!!! VOCÃŠ FINALIZOU O LABIRINTO COM OS "+ (10 + dificuldade) +" PASSOS");
